...
// import 'package:provider/provider.dart';
// import 'package:conass/bloc/biblioteca_bloc.dart';
// import 'package:conass/modelo/post.dart'; // Certifique-se de importar corretamente
...
//     super.initState();
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       int categoriaId = int.parse(
//           widget.post.categoriaBiblioteca); // Conversão de string para int
//       Provider.of<BibliotecaBloc>(context, listen: false)
//           .inCategoria
//           .add(categoriaId);
//     });
...
//                         ),
//                       ),
//                       Text(widget.post.categoriaBiblioteca),
//                     ],
//                   ),
//                 ),
//                 SizedBox(height: 20),
...
//                       return SizedBox(
//                         height:
//                             300, // Defina uma altura fixa para evitar tamanho indefinido
...
//                 child: Container(
//                   decoration: BoxDecoration(
//                     color: Cores.VerdeMedio.withOpacity(0.8),
